...
<?php include 'top-header.php' ?>
   <!-- =====top-header end===== -->
<title>Blogs Details of Dr Rainee Agrawal</title>
   <!-- =====header start===== -->
						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									...
									<div class="meta">
										<div class="meta-left">
											<span class="author"><a href="#"><img src="img/download.jfif" alt="#">Naimur Rahman</a></span>
											<span class="date"><i class="fa fa-clock-o"></i>03 Feb 2019</span>
										</div>
										<div class="meta-right">
											<span class="comments"><a href="#"><i class="fa fa-tags" aria-hidden="true"> </i> Cosmetic Surgery</a></span>
						...
						<div class="main-sidebar">
							...
							<div class="single-widget category">
								...
								<ul class="categor-list">
									<li><a href="#"><i class="fa fa-caret-right"></i> Non Surgical Procedures</a></li>
									<li><a href="#"><i class="fa fa-caret-right"></i> Surgical Procedures</a></li>
									<li><a href="#"><i class="fa fa-caret-right"></i> Other Services</a></li>
									<li><a href="#"><i class="fa fa-caret-right"></i> Miscellaneous Procedures</a></li>
									<li><a href="#"><i class="fa fa-caret-right"></i> Breast Surgery</a></li>
								</ul>
							</div>
							<!--/ End Single Widget -->
							<!-- Single Widget -->
